...
def testSuite : IO Unit := do
  ...
  IO.println s!"1D shape [5]: size = {shape1d.size}"
  IO.println s!"2D shape [3,4]: size = {shape2d.size}"
  IO.println s!"3D shape [2,3,4]: size = {shape3d.size}"
  IO.println s!"4D shape [10,28,28,3]: size = {shape4d.size}"
  IO.println s!"5D shape [2,3,4,5,6]: size = {shape5d.size}"
  IO.println ""
