...
**Prompt:**
```
Currently, in linalg_operations.json, there are values which is like                                                                                                                                                                            │
│                                                                                                                                                                                                                                                   │
│   ```                                                                                                                                                                                                                                             │
│   "code": "Source: https://github.com/numpy/numpy/blob/v2.3.0/numpy/linalg/_linalg.py#L3270-L3340"                                                                                                                                                │
│   ```                                                                                                                                                                                                                                             │
│                                                                                                                                                                                                                                                   │
│   the code is a link to specific lines instead of a complete code which could be found on Github, fix them by using your mcp tool to fetch the doc and code from url given.
```
