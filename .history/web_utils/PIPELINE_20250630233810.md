...
**Prompt:**
```
Use the browsermcp tool to search for all numpy dense matrix linalg operations such as add, multiply and etc. available. Make a list of them in /Users/louhantao/Desktop/code/semester_6.5/NumpySpec/web_utils/basic_ops.json, just the names and urls, leave the in-depth investigation later
```
