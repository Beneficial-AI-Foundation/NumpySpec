...
"For each function, use browsermcp and other tools to search for the docstring and source code, store them in web_utils/output/linalg_operation.json. create a JSON entry with these fields:
{
