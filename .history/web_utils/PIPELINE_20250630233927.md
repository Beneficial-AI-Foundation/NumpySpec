...
"For each function, use browsermcp and other tools to search for the docstring and source code, store them in web_utils/output/linalg_operation.jsoncreate a JSON entry with these fields:
{
