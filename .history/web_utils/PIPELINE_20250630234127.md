...
**Prompt:**
```
Currently, in linalg_operations.json, there are values which isthe code is a link to specific lines instead of a complete code which could be found on Github, fix them by using your mcp tool to fetch the doc and code from url given.
```
